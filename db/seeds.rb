...
Event.create!(title: "Milk Tea Boba Party", address: "135 4th St., San Francisco, CA", city_id: 1, host_id: 2)
Event.create!(title: "What is Boba?!", address: "333 S. State St., Chicago, IL", city_id: 2, host_id: 2)
Event.create!(title: "How much boba...is too much boba??", address: "700 Western St. Los Angeles, CA", city_id: 3, host_id: 2)
Event.create!(title: "Alcoholic Boba Drinks", address: "606 E. Pine St., Seattle, WA", city_id: 4, host_id: 3)
Event.create!(title: "Cup of Boba a day, keeps the doctor away~", address: "400 8th St. NW, Washington, DC ", city_id: 5, host_id: 3)
Event.create!(title: "Matcha Boba Drinks!", address: "23 Clinton St., New York, NY", city_id: 6, host_id: 3)
